...
class DateTimeFilter implements ICustomFilter {
  ...
  DateTimeFilter.lt(String field, DateTime value)
      : this._(field, value, (a, b) => a.isBefore(b));

  DateTimeFilter.gt(String field, DateTime value)
      : this._(field, value, (a, b) => a.isAfter(b));
