...
class SpacedRepetitionSystem {
  ...
  factory SpacedRepetitionSystem.fromJson(Map<String, dynamic> json) =>
      _$SpacedRepetitionSystemFromJson(json);
  Map<String, dynamic> toJson() => _$SpacedRepetitionSystemToJson(this);
